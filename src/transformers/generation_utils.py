...
class GenerationMixin:
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        ### For style transfer we will get the style label first, and we will pass the style labels into the model as forward() need it.
        self.style_labels = inputs['style_labels']
        self.style_cls = inputs['style_classifier']
        self.tokenizer = inputs['tokenizer']
        self.tst_lambda = inputs['tst_lambda']
        self.tst_lambda2 = inputs['tst_lambda2']
        self.num_label = inputs["num_label"]
        self.use_classification_head = inputs['use_classification_head']
        ...
        if is_greedy_gen_mode:
            ...
            beam_scorer = BeamSearchScorer(
                batch_size=batch_size*sum(self.num_label),
                num_beams=num_beams,
                device=inputs_tensor.device,
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            model_inputs["style_labels"] = self.style_labels
            model_inputs["style_classifier"] = self.style_cls
            model_inputs["tokenizer"] = self.tokenizer
            model_inputs["tst_lambda"] = self.tst_lambda
            model_inputs["tst_lambda2"] = self.tst_lambda2
            model_inputs["num_label"] = self.num_label
            model_inputs["use_classification_head"] = self.use_classification_head 
